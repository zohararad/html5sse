...
web build:
 - http://mootools.net/core/f4cfe4760dfedd136294a14475b752c1

packager build:
 - packager build Core/Element Core/Element.Delegation Core/Element.Dimensions Core/Fx Core/Fx.CSS Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/JSON Core/DOMReady
...
}var m=o.getAttributeNode("value");return(m&&m.specified)?o.value:o.get("text");}};}})();(function(){var b={};var a=this.DOMEvent=new Type("DOMEvent",function(c,g){if(!g){g=window;
...
})();(function(){var f=document.html;Element.Properties.styles={set:function(i){this.setStyles(i);}};var h=(f.style.opacity!=null),a=(f.style.filter!=null),g=/alpha\(opacity=([\d.]+)\)/i;
var b=function(j,i){j.store("$opacity",i);j.style.visibility=i>0?"visible":"hidden";};var d=(h?function(j,i){j.style.opacity=i;}:(a?function(j,i){if(!j.currentStyle||!j.currentStyle.hasLayout){j.style.zoom=1;
